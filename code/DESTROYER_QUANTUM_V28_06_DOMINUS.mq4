//+------------------------------------------------------------------+
//|        DESTROYER_QUANTUM_V28_06_DOMINUS.mq4                     |
//|                    Copyright 2026, Quantum Leap Analytics        |
//|  DESTROYER QUANTUM V28.06 DOMINUS - VENI VIDI VICI                 |
...
#property version   "28.06"  // V28.06 DOMINUS: Pure Aggressive, no SX, correct trail
#property strict

/*
==================================================================================================================
==================================================================================================================
   ### V28.06 DOMINUS  PURE AGGRESSIVE, NO SILICON-X ###
==================================================================================================================
   CODENAME: DOMINUS
   DATE: 2026-05-25
   STATUS: BACKTEST PENDING
   
   THE VERDICT (after 3 backtests):
   - Aggressive (no SX): $68,938 | PF 1.89 | 582 trades | BEST
   - RESURRECTION (SX on): $65,747 | PF 1.85 | 546 trades
   - VENDETTA (SX + tight trail): $64,379 | PF 1.83 | 541 trades
   
   CONCLUSION: Silicon-X is a NET NEGATIVE. It consumes Queen exposure
   budget (2.0 lots), starves Reaper of grid entries, and barely profits.
   Reaper PF drops from 1.45 to 1.10 when SX is on.
   
   DOMINUS = Pure Aggressive + Correct pips/points + NO Silicon-X
   
   TARGET: Beat $68,938 and push toward $170K
...
extern int    InpReaper_TrailStop_Pips    = 400;       // DOMINUS: 400 pips (* 10 * _Point = 40 pips effective)
...
//--- Main Parameters
extern bool   InpSiliconX_Enabled           = false;       // DOMINUS: Silicon-X DISABLED (consumes Queen exposure, hurts Reaper)

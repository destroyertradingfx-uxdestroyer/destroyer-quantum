//+------------------------------------------------------------------+
//|        DESTROYER_QUANTUM_V28_06_TITAN.mq4                       |
//|                    Copyright 2026, Quantum Leap Analytics        |
//|  DESTROYER QUANTUM V28.06 TITAN - VENI VIDI VICI                   |
...
#property version   "28.06"  // V28.06 TITAN: Full Kelly + MR + Session expansion + Queen unlocked
#property strict

/*
==================================================================================================================
==================================================================================================================
   ### V28.06 TITAN  FULL AMPLIFICATION ###
==================================================================================================================
   CODENAME: TITAN
   DATE: 2026-05-25
   STATUS: BACKTEST PENDING
   
   BUILT ON: IMPERATOR (Queen unlocked, full grid, MR activated)
   ADDS: Kelly amplification + Mean Reversion activation + Session expansion
   
   KELLY AMPLIFICATION (+$28K-$40K expected):
   1. Half-Kelly -> Three-Quarter Kelly (0.5 -> 0.75)
   2. Blend 60/40 -> 80/20 (more Kelly weight)
   3. Risk cap 2.0% -> 3.0%
   4. Combined multiplier cap 2.0x -> 3.0x
   5. Max loss per trade $500 -> $800
   6. Base risk 1.5% -> 2.0%
   7. Reaper InitialLot 0.12 -> 0.18
   8. Reaper BasketTP $600 -> $900
   
   MEAN REVERSION ACTIVATION (+$5K-$15K expected):
   9. BB Dev 2.0 -> 1.5 (more overextension signals)
   10. Hurst 0.55 -> 0.50 (allow mild trends)
   11. ADX Max 30 -> 40 (allow fading moderate trends)
   12. RSI divergence relaxed (strict -> oversold/overbought levels)
   13. Allow 3 concurrent MR trades (was 1)
   
   SESSION EXPANSION (+$8K-$15K expected):
   14. SessionMomentum time 8-18 -> 6-20 (Asian->NY)
   15. SessionMomentum ADX 20 -> 15 (more breakouts)
   16. Allow 2 concurrent Session trades (was 1)
   17. Session lookback 6 -> 4 bars (tighter range)
   18. Nexus CompressionBars 3 -> 2
   19. Nexus CompressionRatio 0.75 -> 0.85
   20. Nexus MedianLookback 50 -> 30
   
   PROJECTED: $109K-$138K profit, DD 27-32%, 750-850 trades
...
void ExecuteDivergenceMR()
{
   ...
   bool bullishDivergence = (rsi_1 < 35);  // TITAN: RSI oversold (relaxed from strict divergence)
   // RSI Bearish Divergence: Price makes higher high, RSI makes lower high
   bool bearishDivergence = (rsi_1 > 65);  // TITAN: RSI overbought (relaxed from strict divergence)

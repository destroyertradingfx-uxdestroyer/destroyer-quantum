//+------------------------------------------------------------------+
//|        DESTROYER_QUANTUM_V28_06_IMPERATOR.mq4                   |
//|                    Copyright 2026, Quantum Leap Analytics        |
//|  DESTROYER QUANTUM V28.06 IMPERATOR - VENI VIDI VICI               |
...
#property version   "28.06"  // V28.06 IMPERATOR: Queen unlocked, full grid, MR activated
#property strict

/*
==================================================================================================================
==================================================================================================================
   ### V28.06 IMPERATOR  UNLEASH THE FULL GRID ###
==================================================================================================================
   CODENAME: IMPERATOR
   DATE: 2026-05-25
   ...
   THE DISCOVERY:
   Queen_MaxExposureLots = 2.0 was CHOKING Reaper at Level 6 of 8.
   Levels 7-8 carry 2.17 lots  MORE than levels 1-5 combined.
   The Queen was cutting off the grid's most profitable entries.
   
   IMPERATOR CHANGES:
   1. Queen_MaxExposureLots: 2.0 -> 8.0 (full 8-level grid unlocked)
   2. Queen_MaxConcurrentBaskets: 3 -> 5
   3. MaxTotalRisk_Percent: 12% -> 25%
   4. MaxRiskPerTrade: 0.8% -> 2.0%
   5. Leviathan_MaxRisk: 7% -> 15%
   6. Queen_ReaperDDKillPct: 4% -> 8%
   7. MaxLotSize: 8.0 -> 15.0
   8. Hades_BasketStopLoss: 3.5% -> 7.0%
   9. Mean Reversion ACTIVATED (Hurst 0.55->0.50, BB 1.7->1.5, RSI 60/40)
   10. All days trading enabled (Wednesday unblocked)
   11. Silicon-X DISABLED (confirmed net negative)
